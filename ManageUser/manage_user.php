...
if ($checkColumn->num_rows === 0) {
    ...
    $conn->query("UPDATE users SET created_at = NOW() WHERE created_at IS NULL");
}

// Fetch users from database
$sql = "SELECT id, name, email, role, created_at FROM users ORDER BY role, created_at DESC";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled permission-list">
                            ...
                            <li><i class="bi bi-check-circle-fill text-success"></i> Upload client & partner agreements only</li>
                            <li><i class="bi bi-check-circle-fill text-success"></i> View & download agreements only</li>
